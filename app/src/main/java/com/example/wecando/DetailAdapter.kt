...
//            DetailModel.ADD -> (holder as EditViewHolder).title.text = obj.title
                ...
                Handler().postDelayed({
                    if (clickCnt == 1) {
                        ...
                        if (obj.status == DetailModel.RUNNING && !isDuplicated) {
                            ...
                            details.set(position, DetailModel(DetailModel.MODIFY, id, "", order))
                            notifyDataSetChanged()
                            (context as DetailActivity).ModifyDetail(id, position, title)
                        }
...
//                    details.set(position, DetailModel(DetailModel.MODIFY, id, "", order))
//                    notifyDataSetChanged()
//                    (context as DetailActivity).ModifyDetail(id, position)
//                }
//            }
//            doubleClick = true
