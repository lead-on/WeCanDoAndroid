...
class EditAdapter(val profileList: ArrayList<ListModel>, val listener: ItemDragListener, val context: Context) : RecyclerView.Adapter<EditAdapter.CustomViewHolder>(), ItemActionListener {
